...
#
# JS  test web
# Web Site: https://www.AW-data-tonycti
#
#############################################################
...
UUID=${UUID:-'447019c6-fe97-4bf3-92a3-5873e8eb6538'}
VMESS_WSPATH=${VMESS_WSPATH:-'/vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/vless'}
URL=${USER}.alwaysdata.net

wget -q -O $TMP_DIRECTORY/config.json https://raw.githubusercontent.com/tonycti/Awdata/main/config.json
...
vmlink=vmess://$(echo -n "{\"v\":\"2\",\"ps\":\"AW-data-tonycti\",\"add\":\"$URL\",\"port\":\"443\",\"id\":\"$UUID\",\"aid\":\"0\",\"net\":\"ws\",\"type\":\"none\",\"host\":\"$URL\",\"path\":\"$VMESS_WSPATH\",\"tls\":\"tls\"}" | base64 -w 0)
vllink="vless://"$UUID"@"$URL":443?encryption=none&security=tls&type=ws&host="$URL"&path="$VLESS_WSPATH"#AW-data-tonycti"
...
#############################################################
#
# Test Web Site: https://www.AW-data-tonycti
#
#############################################################
EOF
)
