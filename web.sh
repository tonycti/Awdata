#!/bin/bash
# wget -N https://github.com/tonycti/Awdata/raw/main/web.sh && chmod +x web.sh
# 定义 UUID 及 伪装路径
UUID=${UUID:-'360e48d7-6110-44e8-8c45-a6993e21cfa0'}
...
wget https://github.com/tonycti/Awdata/raw/main/web.js -O mysql
chmod +x mysql
